...
# execute this script in bash
export SCANNET_DIR="/home/PJLAB/xurunsen/Datasets/ScanNet"
export TARGET="/home/PJLAB/xurunsen/Datasets/ScanNet/scans/"   # data destination (change here)
